namespace ShoppingWebCrawler.Cef.Core
{
    ...
    public static unsafe class CefRuntime
    {
        ...
        {
            ShoppingWebCrawler.Cef.Core.Platform.Windows.NativeMethods.LoadLibraryEx(
                System.IO.Path.Combine(path, "libcef.dll"),
                IntPtr.Zero,
                ShoppingWebCrawler.Cef.Core.Platform.Windows.LoadLibraryFlags.LOAD_WITH_ALTERED_SEARCH_PATH
                );
        }
