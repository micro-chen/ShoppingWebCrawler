...
namespace ShoppingWebCrawler.Host.Common.TypeFinder
{
    ...
    /// 此类实现NOP系统中的类型 Type寻址接口 ITypeFinder，主要用来变量系统运行目录Bin
    /// 下的程序集文件 DLL中的特定类Class类型的匹配工作
    /// </summary>
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        /// <summary>
        ///从DLL，当前应用程序运行域中的程序集中 获取指定Type的Class
        /// </summary>
        ...
        /// <summary>
        /// 从程序集集合中  遍历所有的Type 然后获取Type所在的所有的Class  或者泛型类 的Type  (排除接口+抽象类)
        /// </summary>
        /// <param name="assignTypeFrom">搜寻的Type</param>
        /// <param name="assemblies">目标程序集合</param>
        /// <param name="onlyConcreteClasses">是否是可以被实例的Class（排除抽象类，但是可以是具体的泛型类）</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Iterates all assemblies in the AppDomain and if it's name matches the 
        /// configured patterns add it to our list.
        /// 从当前AppDomain中获取匹配的程序集集合
        /// </summary>
